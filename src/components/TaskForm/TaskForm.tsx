...
const EMPTY: TaskFormData = {
 ...
 function TaskForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-2xl shadow p-4 grid gap-3">
      <div>
      ...
      <div>
        <label htmlFor={descId} className="block text-sm font-medium">Description</label>
        <textarea
          id={descId}
          rows={3}
